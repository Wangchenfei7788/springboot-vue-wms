...
export default {
  ...
  methods:{
    ...
    doSave(){
      this.$axios.post(this.$httpUrl+'/goodtype/save',this.form).then(res=>res.data).then(res=>{
        console.log(res)
        if(res.code==200){
          this.$notify({
            title: '成功',
    ...
    doMod(){
      this.$axios.post(this.$httpUrl+'/goodtype/update',this.form).then(res=>res.data).then(res=>{
        console.log(res)
        if(res.code==200){
          this.$notify({
            title: '成功',
    ...
    del(id){
      ...
      this.$axios.get(this.$httpUrl+'/goodtype/del?id='+id).then(res=>res.data).then(res=>{
        console.log(res)
        if(res.code==200){
          this.$message({
...
<template>
  <div>
    ...
    <el-table style="width: 100%"
      ...
      <el-table-column prop="name" label="产品分类" width="200">
      </el-table-column>
